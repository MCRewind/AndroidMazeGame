...
public class DPad extends UIObject {
    ...
    public DPad(Camera camera, float x, float y, float width, float height) {
        ...
        directions[0] = new UIImage(camera, new Texture(R.drawable.d_upleft),    new Shader(R.raw.defaultvs, R.raw.defaultfs), x,                    y,                     width / 3.0f, height / 3.0f);
        directions[1] = new UIImage(camera, new Texture(R.drawable.d_up),        new Shader(R.raw.defaultvs, R.raw.defaultfs), x + width / 3.0f,     y,                     width / 3.0f, height / 3.0f);
        directions[2] = new UIImage(camera, new Texture(R.drawable.d_upright),   new Shader(R.raw.defaultvs, R.raw.defaultfs), x + 2 * width / 3.0f, y,                     width / 3.0f, height / 3.0f);
        directions[3] = new UIImage(camera, new Texture(R.drawable.d_left),      new Shader(R.raw.defaultvs, R.raw.defaultfs), x,                    y + height / 3.0f,     width / 3.0f, height / 3.0f);
        directions[4] = new UIImage(camera, new Texture(R.drawable.d_right),     new Shader(R.raw.defaultvs, R.raw.defaultfs), x + 2 * width / 3.0f, y + height / 3.0f,     width / 3.0f, height / 3.0f);
